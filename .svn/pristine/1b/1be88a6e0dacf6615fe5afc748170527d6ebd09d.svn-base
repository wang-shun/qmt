...
public class TTag implements org.apache.thrift.TBase<TTag, TTag._Fields>, java.io.Serializable, Cloneable, Comparable<TTag> {
  ...
  static {
    schemes.put(StandardScheme.class, new TTagStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TTagTupleSchemeFactory());
  }
  ...
  private static class TTagStandardSchemeFactory implements SchemeFactory {
    public TTagStandardScheme getScheme() {
      return new TTagStandardScheme();
    }
  }

  private static class TTagStandardScheme extends StandardScheme<TTag> {
  ...
  private static class TTagTupleSchemeFactory implements SchemeFactory {
    public TTagTupleScheme getScheme() {
      return new TTagTupleScheme();
    }
  }

  private static class TTagTupleScheme extends TupleScheme<TTag> {
