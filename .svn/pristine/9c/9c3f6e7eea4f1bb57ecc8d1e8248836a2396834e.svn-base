 ...
 */
@RestController
@RequestMapping(value="/appMenus")
@WebLogAnnotation(ID_TYPE = IdType.MENU)
public class AppMenuController extends AbstractQmtController<MenuVo, Long> {

    private static final Logger LOG = LoggerFactory.getLogger(AppMenuController.class);
    ...
    @ResponseBody
    @PreAuthorize("hasPermission('lesports.qmt.mobileConf.mobileMenu', 'ADD')")
    ...
    @ResponseBody
    @Override
    @PreAuthorize("hasPermission('lesports.qmt.mobileConf.mobileMenu', 'DELETE')")
    ...
    @ResponseBody
    @PreAuthorize("hasPermission('lesports.qmt.mobileConf.mobileMenu', 'UPDATE')")
