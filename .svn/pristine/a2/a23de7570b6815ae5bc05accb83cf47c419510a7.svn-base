...
function usage(){
  ...
  echo "    -n: Optional. Set the namespace or package to find the ipad. "
  echo "                  Default value is com.lesports.qmt.ipad.api"
  echo "    -m: Optional. Entry class name without package. Default is Main."
  echo "    -s: Optional. Service Name. Default is lesports-qmt-ipad-api-web."
}
...
PKG="com.lesports.qmt.ipad.api"
NAME="SmsIpadApiServer"
# Default port.
CMD=""
SERVICE_NAME="lesports-qmt-ipad-api-web"
...
DUMP_LOG="${LOG_DIR}/dump-${PORT}.log"
