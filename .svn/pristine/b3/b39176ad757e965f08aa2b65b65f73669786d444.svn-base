...
//import com.lesports.qmt.sbc.api.dto.TSaimpleVideo;
...
@Controller
@RequestMapping("/")
public class AppMSitePlayDataController {

    private final static Logger LOG = LoggerFactory.getLogger(AppMSitePlayDataController.class);
