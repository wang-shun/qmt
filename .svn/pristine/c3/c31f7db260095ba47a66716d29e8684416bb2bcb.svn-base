...
public class JettyServerFactory {
    ...
    public static Server createServer5ConfigFile(final int port) {
        Server server = null;
        try {
            Resource jettyXml = Resource.newSystemResource("com/lesports/qmt/play/jetty.xml");
            if (jettyXml == null) {
                return null;
            }
            ...
            LOG.error("fail to create jetty server from config : com/lesports/qmt/play/jetty.xml", e);
            return null;
        }
