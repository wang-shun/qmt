 ...
 */
public class HkSwiftMessageApis {
    private static final Logger LOG = LoggerFactory.getLogger(HkSwiftMessageApis.class);
    private static final String dest = "lesports.qmt.msg.hk.direct/lesports.routingkey.qmt.msg.hk"; //exchangeName/routingKeyName
    private static ExecutorService executorService = Executors.newFixedThreadPool(5);
    private static JmsTemplate leJmsTemplate;

    static {
        synchronized (HkSwiftMessageApis.class) {
            try {
                AMQConnectionFactory factory = new AMQConnectionFactory(MsgProducerConstants.HK_SWIFTQ_CONNECTION_URL);
