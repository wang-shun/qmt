...
import com.lesports.qmt.cms.thrift.TCmsServiceAdapter;
...
public class TCmsServer {
    private static final Logger LOG = LoggerFactory.getLogger(TCmsServer.class);
    ...
    public static void main(String... args) {
        ...
        ServiceConfig config = ServiceConfig.newBuilder()
                .serviceFace(TCmsService.Iface.class)
                .serviceImpl(TCmsServiceAdapter.class)
                .port(port)
