 ...
 */
@RestController
@RequestMapping(value="/tvMenus")
@WebLogAnnotation(ID_TYPE = IdType.MENU)
public class TvMenuController extends AbstractQmtController<MenuVo, Long> {

    private static final Logger LOG = LoggerFactory.getLogger(TvMenuController.class);
    ...
    @ResponseBody
    @PreAuthorize("hasPermission('lesports.qmt.tvConf.TVmenu', 'ADD')")
    ...
    @ResponseBody
    @Override
    @PreAuthorize("hasPermission('lesports.qmt.tvConf.TVmenu', 'DELETE')")
    ...
    @ResponseBody
    @PreAuthorize("hasPermission('lesports.qmt.tvConf.TVmenu', 'UPDATE')")
