 ...
 */
public class TvContentCvo extends BaseCvo {
    ...
    //TV桌面推荐主题的子内容
    private List<TvContentCvo> items = Lists.newArrayList();
    ...
    public List<TvContentCvo> getItems() {
        return items;
    }

    public void setItems(List<TvContentCvo> items) {
        this.items = items;
    }
