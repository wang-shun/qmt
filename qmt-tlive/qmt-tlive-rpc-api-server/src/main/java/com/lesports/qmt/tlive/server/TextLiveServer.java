...
import com.lesports.qmt.tlive.thrift.TTextLiveServiceAdapter;
 ...
 */
public class TextLiveServer {
    private static final Logger LOG = LoggerFactory.getLogger(TextLiveServer.class);
    ...
    public static void main(String... args) {
        ...
        ServiceConfig config = ServiceConfig.newBuilder()
                .serviceFace(TTextLiveService.Iface.class)
                .serviceImpl(TTextLiveServiceAdapter.class)
                .port(port)
