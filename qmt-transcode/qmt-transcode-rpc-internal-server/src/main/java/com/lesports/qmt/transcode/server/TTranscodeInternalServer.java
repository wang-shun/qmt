...
/**
 * Created by pangchuanxiao on 2016/3/23.
 */
public class TTranscodeInternalServer {
    private static final Logger LOG = LoggerFactory.getLogger(TTranscodeInternalServer.class);
    ...
    public static void main(String... args) {
        ...
        ServiceConfig config = ServiceConfig.newBuilder()
                .serviceFace(TTranscodeInternalService.Iface.class)
                .serviceImpl(TTranscodeInternalServiceAdapter.class)
                .port(port)
