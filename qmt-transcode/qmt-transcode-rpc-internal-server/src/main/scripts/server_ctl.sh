...
PKG="com.lesports.qmt.transcode.server"
NAME="TTranscodeInternalServer"
# Default port.
CMD=""
SERVICE_NAME="lesports-transcode-rpc-internal-server"
...
-Dlog.path=${STD_LOG} -Dlog.dir=${LOG_DIR}"
