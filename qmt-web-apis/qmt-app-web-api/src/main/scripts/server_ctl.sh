...
function usage(){
  ...
  echo "                  Default value is com.lesports.qmt.app.api"
  echo "    -m: Optional. Entry class name without package. Default is Main."
  echo "    -s: Optional. Service Name. Default is lesports-qmt-app-api-web."
}
...
PKG="com.lesports.qmt.app.api"
NAME="SmsAppApiServer"
# Default port.
CMD=""
SERVICE_NAME="lesports-qmt-app-api-web"
