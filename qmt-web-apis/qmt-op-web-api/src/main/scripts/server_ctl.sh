...
function usage(){
  ...
  echo "                  Default value is com.lesports.qmt.op.api"
  echo "    -m: Optional. Entry class name without package. Default is Main."
  echo "    -s: Optional. Service Name. Default is qmt-op-web-api."
}
...
PKG="com.lesports.qmt.op.web.api"
NAME="QmtOpApiServer"
# Default port.
CMD=""
SERVICE_NAME="qmt-op-web-api"
