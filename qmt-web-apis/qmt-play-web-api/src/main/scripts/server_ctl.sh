...
function usage(){
  ...
  echo "                  Default value is com.lesports.sms.app.api"
  echo "    -m: Optional. Entry class name without package. Default is Main."
  echo "    -s: Optional. Service Name. Default is lesports-sms-app-api-web."
}
...
PKG="com.lesports.qmt.play.api"
NAME="PlayApiServer"
# Default port.
CMD=""
SERVICE_NAME="qmt-play-web-api"
