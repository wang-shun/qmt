...
function usage(){
  ...
  echo "                  Default value is com.lesports.qmt.tv.api"
  echo "    -m: Optional. Entry class name without package. Default is Main."
  echo "    -s: Optional. Service Name. Default is lesports-qmt-tv-api-web."
}
...
PKG="com.lesports.qmt.tv.api"
NAME="SmsTVApiServer"
# Default port.
CMD=""
SERVICE_NAME="lesports-qmt-tv-api-web"
